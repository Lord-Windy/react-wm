...
C/C++ (8 years), Java (7 years) Network Code(7 years), Thrift, Swift, Javascript, HTML+CSS, Git, SVN, Python, Lua

### Current Projects (Brief):

* *React-WM:-* A desktop in a browser and you are currently inside a version of it. More spoken about in it’s own App. Github Link.
